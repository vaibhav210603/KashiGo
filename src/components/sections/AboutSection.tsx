        ...
        <section id="about" ref={containerRef} className="relative py-24 bg-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-2xl md:text-3xl font-cursive text-orange-500 mb-3">About KashiGo</h2>
                    <h3 className="text-4xl md:text-6xl font-bold font-heading text-slate-900 mb-6">Redefining Spiritual Journeys</h3>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6 text-lg text-slate-600">
                        <p>
                            KashiGo is Varanasi&apos;s premier boat ride booking platform, offering structured, transparent, and luxurious spiritual experiences on the river Ganges.
                        </p>
                        <p>
                        ...
                        <ul className="space-y-4 pt-4">
                            {['Transparent Pricing', 'Verified & Safe Boats', 'Premium Experience', 'Flexible Timings'].map((feature, idx) => (
